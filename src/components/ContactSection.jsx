    ...
    <section id="contact" className="bg-porcelain px-4 py-20 sm:px-6 lg:px-8">
      <div className="mx-auto max-w-7xl">
        <SectionHeading
          ...
          text="Tell us your destination, purpose of travel, and target date. We will guide you with the most practical next step."
        />
        ...
        <div className="grid gap-6 lg:grid-cols-[0.95fr_1.05fr]">
            ...
            <div className="space-y-5 p-7">
              ...
              <div className="rounded-3xl border border-white/10 bg-white/10 p-4">
                ...
                <iframe
                  ...
                  src="https://www.google.com/maps?q=India%20business%20district&output=embed"
          ...
          <form className="premium-card rounded-[2rem] p-6 md:p-8" aria-label="Visa consultation form">
            <div className="grid gap-5 md:grid-cols-2">
              ...
              <Field label="Phone / WhatsApp" name="phone" placeholder="+91 98765 43210" />
